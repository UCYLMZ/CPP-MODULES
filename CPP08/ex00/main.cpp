...
int main(void)
{
	// list (non-contigous memory, only linear access)
	std::cout << "\n### LIST ###" << std::endl;
	try
	{
		std::list<int> list;
	...
	// vector (only push back, elements are contigous in the memory, allows indexing)
	std::cout << "\n\n### VECTOR ###" << std::endl;
	try
	{
	...
	// set (non-contigous memory, all elements are unique, only linear access)
	std::cout << "\n\n### SET ###" << std::endl;
	try
	{
		std::set<int> set;
	...
	// deque (non-contigous memory, allows indexing)
	std::cout << "\n\n### DEQUE ###" << std::endl;
	try
	{
		std::deque<int> deque;
